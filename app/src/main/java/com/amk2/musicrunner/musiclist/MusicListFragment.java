...
public class MusicListFragment extends Fragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(mActivity).registerReceiver(mCreatePlaylistReceiver, new IntentFilter(CREATE_PLAYLIST));
        LocalBroadcastManager.getInstance(mActivity).registerReceiver(mUpdatePlaylistReceiver, new IntentFilter(UPDATE_PLAYLIST));
        mUserInstructionSharedPreferences = mActivity.getSharedPreferences(Constant.USER_INSTRUCTION, Context.MODE_PRIVATE);
        hasIntroduced = mUserInstructionSharedPreferences.getBoolean(Constant.PLAYLIST_PAGE, false);
    ...
    private void setViews() {
        ...
        playlistContainer.setAdapter(new PlaylistPinnedSectionListAdapter(mActivity, R.layout.music_list_item_template, mPlaylistMetaData));
        ...
        // set up introduction click listener
        if (!hasIntroduced) {
            introduction.setVisibility(View.VISIBLE);
            introduction.setOnClickListener(this);
            hasIntroduced = true;
            mUserInstructionSharedPreferences.edit().remove(Constant.PLAYLIST_PAGE).putBoolean(Constant.PLAYLIST_PAGE, true).commit();
        }
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (extras.get(MusicAddToPlaylistActivity.UPDATE_ALL_PLAYLIST) != null){
                ...
                if (isBpmUpdated) {
                    ...
                    playlistMetaDatas.add(new PlaylistSectionData(mActivity.getResources().getString(R.string._30_mins_playlist)));
                    playlistMetaDatas.add(halfHourSlowPlaylistMetaData);
                    playlistMetaDatas.add(halfHourMediumPlaylistMetaData);
                    playlistMetaDatas.add(new PlaylistSectionData(mActivity.getResources().getString(R.string._1_hour_playlist)));
                    playlistMetaDatas.add(oneHourSlowPlaylistMetaData);
                    playlistMetaDatas.add(oneHourMediumPlaylistMetaData);
                    playlistMetaDatas.add(new PlaylistSectionData(mActivity.getResources().getString(R.string.your_playlist)));
                    ArrayList<PlaylistMetaData> UGPlaylistMetaDatas = playlistManager.getUserGeneratedPlaylist();
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
        if (playlistPinnedSectionListAdapter.getItemViewType(position) == PlaylistPinnedSectionListAdapter.TYPE_PLAYLIST) {
            Intent intent = new Intent(mActivity, MusicListDetailActivity.class);
            ...
            switch(action) {
                ...
                case (MotionEvent.ACTION_UP) :
                    ...
                    if (isMove && viewTag.position > 6) {
                        ...
                        viewTag = (PlaylistContainerTag) view.getTag();
                        Intent intent = new Intent(mActivity, MusicListDetailActivity.class);
    ...
    public class SongLoaderRunnable implements Runnable, LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
            return new CursorLoader(mActivity, MusicLib.getMusicUri(), MUSIC_SELECT_PROJECTION, null, null, null);
        }
        ...
        public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
            ...
            playlistManager.setContext(mActivity);
